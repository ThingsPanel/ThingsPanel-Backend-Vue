  ...
  */
  ...
  SYSTEM_MANAGEMENT: {
    ...
    NOTICE_MANAGEMENT: {
      ...
      PLACEHOLDER5:"请输入邮箱",
      PLACEHOLDER6:"通知方式是邮箱，提示多个邮箱使用英文逗号隔开",
      PLACEHOLDER7:"通知方式是短信，提示多个手机号用英文逗号隔开",
      PLACEHOLDER8:"通知方式是语音，提示多个手机号用英文逗号隔开",
      PLACEHOLDER9:"请输入url",
      PLACEHOLDER10:"请输入手机号",
      SRARTED: "已启用",
      PUTONHOLD: "已停用",
      START: "启动",
      SUSPENDED: "暂停",
  ...
  DATASERVICE_MANAGEMENT: {
    ...
    FORMNAME:"名称",
    FORMWAY:"签名方式",
    FORMIPWHITELIST:"IP白名单",
    FORMINTERFACE_SUPPORT_FLAG:"接口支持标志",
    FORMSPACE:"推送数据间隔",
    FORMDESC:"描述",
    FORMSQL:"SQL",
    FORMSQLWRITiINGASSISTANCE:"SQL编写辅助",
    TABLE:"字段名",
    TABLE1:"数据类型",
    TABLE2:"注释",
    BTN:"SQL调试",
